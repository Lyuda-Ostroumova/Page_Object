...
public class DashboardPage {
    ...
    private static SelenideElement firstCard = $("[data-test-id='92df3f1c-a033-48e6-8390-206f6b1f56c0'] [data-test-id='action-deposit']");
    private static SelenideElement secondCard = $("[data-test-id='0f3f5c2a-249e-4c3d-8287-09f7a039391d'] [data-test-id=action-deposit]");
    private SelenideElement reloadButton = $("[data-test-id='action-reload']");


    public static MoneyTransferPage firstCard() {
        firstCard.click();
        return new MoneyTransferPage();
    }

    public static MoneyTransferPage secondCard() {
        secondCard.click();
        return new MoneyTransferPage();
    }
